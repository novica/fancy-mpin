class PayRecord(db.Model):
    ...
    EffectiveWork = db.Column(db.Decimal,  nullable=False)
    FeeHours = db.Column(db.Integer)
    FeeType = db.Column(db.String(3))
    FeeAmount = db.Column(db.Decimal,  nullable=False)
    UnemploymentYear = db.Column(db.String(4))
    GrossPay = db.Column(db.Decimal,  nullable=False)
    DeductionPiom = db.Column(db.Decimal,  nullable=False)
    AdditionalPiom = db.Column(db.Decimal,  nullable=False)
    DeductionFzom = db.Column(db.Decimal,  nullable=False)
    AdditionalFzom = db.Column(db.Decimal,  nullable=False)
    DeductionWorkInjury = db.Column(db.Decimal,  nullable=False)
    AdditionalWorkInjury = db.Column(db.Decimal,  nullable=False)
    DeductionUnemploment = db.Column(db.Decimal,  nullable=False)
    AdditioanlUnemployment = db.Column(db.Decimal,  nullable=False)
    PDD = db.Column(db.Decimal,  nullable=False)
    ...
    BenefitsPay = db.Column(db.Decimal,  nullable=False)
    DeductionBenefits = db.Column(db.Decimal,  nullable=False)
    AdditionallBenefits = db.Column(db.Decimal,  nullable=False)
    StateAuthorityID = db.Column(db.String(3))
    StateAuthorityHours = db.Column(db.Ingeter)
    StateAuthorityPay =  db.Column(db.Decimal,  nullable=False)
    ...
    NetPay = db.Column(db.Decimal,  nullable=False)
    PayDue = db.Column(db.Decimal,  nullable=False)
...
class Deductions(db.Model):
    ...
    id = db.Column(db.Integer, primary_key=True)
    Year = db.Column(db.Integer, nullable=False)
    TaxDeductions = db.Column(db.Decimal,  nullable=False)